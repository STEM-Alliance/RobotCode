...
{
    private static IRobotConfig explicitDefault = null;
     ...
     */
    public static IRobotConfig get(IRobotConfig[] configs)
    {
     ...
     */
    public static IRobotConfig get(IRobotConfig[] configs, String file)
    {
        String path = "";
        String rcName = "";
        ...
        for (IRobotConfig robotConfig : configs)
        {
    ...
    public static void setDefault(IRobotConfig config)
    {
        explicitDefault = config;
    }

    private static IRobotConfig useDefault(String path, IRobotConfig implicitDefault)
    {
        IRobotConfig result = (explicitDefault != null) ? explicitDefault : implicitDefault;
