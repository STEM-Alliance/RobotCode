...
public class CameraServer extends CrashTrackingRunnable
{
    ...
    public void runCrashTracked()
    {
        ...
        SmartDashboard.putString("Connection", "Waiting for clients to connect at " + serverSocket.getInetAddress().getHostAddress() + ":" + serverSocket.getLocalPort());
        while (true)
        {
            try
            {
    ...
    private class Connection extends CrashTrackingRunnable
    {
        ...
        public void runCrashTracked()
        {
            ...
            try
            {
                ...
                SmartDashboard.putString("Connection", "Connected to a client at " + socket.getInetAddress().getHostAddress());
                ...
                SmartDashboard.putString("Connection", "Socket disconnected");
            }
            catch (IOException e)
            {
                System.err.println("Could not talk to socket");
                SmartDashboard.putString("Connection", "Could not talk to socket");
